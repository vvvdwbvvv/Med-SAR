...
def evaluate_model(rows: List[Dict], model_ckpt: str, input_field: str, label_field: str) -> Dict[str, float]:
...
def main():
    ...
    with out_csv.open("w", newline="") as f:
        ...
        for name, path in ckpts:
            metrics = evaluate_model(rows, model_ckpt=path, input_field=args.input_field, label_field=args.label_field)
