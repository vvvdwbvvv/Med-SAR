...
# Single model
# python scripts/14_eval_post-train.py \
#   --models sft=models/doctor_sft_v2 \
#   --datasets medmcqa pubmedqa mmlu_clinical \
#   --out_csv results/additional_datasets.csv

# # Multiple models with comparison
# python scripts/14_eval_post-train.py \
#   --models sft=models/doctor_sft_v2 medsar=models/doctor_round_5 base=meta-llama/Llama-3.2-3B-Instruct \
